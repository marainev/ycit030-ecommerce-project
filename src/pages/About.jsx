...
const About = () => {
    return (
        <div className='page-heading'>
            ...
            <div className='about'>
                <p>
                    Sea Gato is an independent bookstore for sci-fi enthusiasts in the heart of Prague. Since its establishment, we have been 
                ...
                &nbsp;
                <p>
                    At Sea Gato, we take pride in offering a carefully selected range of science fiction literature, including classic works, 
                ...
                &nbsp;
                <p> 
                    Whether you are a seasoned sci-fi aficionado or just dipping your toes into the genre, Sea Gato invites you to embark on an extraordinary reading journey. 
                </p>  
                &nbsp;   
                <p>
